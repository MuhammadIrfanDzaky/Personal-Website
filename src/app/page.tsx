...
export default function Home() {
  const techStack = {
    ...
    backend: [
      { name: 'NestJS', icon: <SiNestjs />, color: 'cyan' as const, iconColor: '#E0234E', level: 85, years: '1+' },
      { name: 'Node.js', icon: <FaNodeJs />, color: 'cyan' as const, iconColor: '#339933', level: 80, years: '1+' },
      { name: 'Prisma ORM', icon: <SiPrisma />, color: 'cyan' as const, iconColor: '#2D3748', level: 80, years: '1+' },
      { name: 'PHP', icon: <FaPhp />, color: 'cyan' as const, iconColor: '#777BB4', level: 75, years: '2+' },
    ],
    database: [
      { name: 'PostgreSQL', icon: <SiPostgresql />, color: 'cyan' as const, iconColor: '#4169E1', level: 85, years: '1+' },
      { name: 'MySQL', icon: <SiMysql />, color: 'cyan' as const, iconColor: '#4479A1', level: 80, years: '2+' },
    ],
    tools: [
      { name: 'Git', icon: <FaGitAlt />, color: 'cyan' as const, iconColor: '#F05032', level: 85, years: '2+' },
      { name: 'VS Code', icon: <VscCode />, color: 'cyan' as const, iconColor: '#007ACC', level: 90, years: '2+' },
      { name: 'Postman', icon: <SiPostman />, color: 'cyan' as const, iconColor: '#FF6C37', level: 85, years: '1+' },
      { name: 'Swagger', icon: <SiSwagger />, color: 'cyan' as const, iconColor: '#85EA2D', level: 80, years: '1+' },
      { name: 'npm', icon: <FaNpm />, color: 'cyan' as const, iconColor: '#CB3837', level: 85, years: '2+' },
    ],
  };
    ...
    <TooltipProvider delayDuration={200}>
      ...
      <main className="relative z-10 w-full px-6 md:px-12 lg:px-16 pt-20 md:pt-28 pb-24 md:pb-8 flex flex-col">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8 lg:gap-12 items-center relative z-10">
              ...
              <div className="md:col-span-1 flex justify-center md:justify-start">
                <div className="relative group/photo">
                  ...
                  <a 
                    ...
                    className="block w-48 h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 rounded-2xl border-4 border-neon-cyan overflow-hidden bg-dark-700 relative hover:border-neon-cyan transition-all duration-500 hover:shadow-2xl hover:shadow-neon-cyan hover:rotate-2 transform cursor-pointer"
                    title="Click Me!"
                  >
                    <Image 
                  ...
                  <div className="absolute -left-2 bottom-1/4 w-16 h-0.5 bg-neon-cyan opacity-0 group-hover/photo:opacity-100 transition-opacity" />
                </div>
              </div>
              ...
              <div className="md:col-span-3 space-y-4 md:space-y-6 text-center md:text-left">
                <div className="space-y-3 md:space-y-4">
                  ...
                  <h1
                    className="text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-tight mb-3 md:mb-4"
                  >
                  ...
                  <p className="text-gray-400 text-base md:text-lg lg:text-xl leading-relaxed max-w-3xl text-center md:text-left">
                    Still Somewhere Between <span className="font-bold">Junior</span> and <span className="font-bold">Figuring It Out</span>.
                  </p>
        ...
        <div className="grid md:grid-cols-5 gap-4 md:gap-6 mb-8">
          ...
          <div className="md:col-span-3 bg-dark-800/50 backdrop-blur-sm border-2 border-neon-cyan/30 rounded-2xl p-4 md:p-6 relative group hover:border-neon-cyan/60 transition-all duration-500">
            <div className="absolute top-2 right-2 md:top-4 md:right-4 text-neon-cyan/20 text-4xl md:text-6xl font-mono">01</div>
              ...
              <div className="flex items-center gap-2 md:gap-3 mb-4 md:mb-6">
                <div className="w-1 h-6 md:h-8 bg-neon-cyan flicker-slow" />
              ...
              <div className="space-y-3 mb-5 md:mb-6">
                <div className="flex items-start gap-3 group/item hover:translate-x-1 transition-transform">
                  ...
                  <p className="text-gray-300 text-base md:text-lg"><span className="font-bold">Full-stack developer</span> specializing in <span className="font-semibold">Next.js</span> and <span className="font-semibold">NestJS</span></p>
                </div>
                <div className="flex items-start gap-3 group/item hover:translate-x-1 transition-transform">
                  <span className="text-neon-cyan text-xl md:text-2xl mt-0.5">▹</span>
                  <p className="text-gray-300 text-base md:text-lg">Passionate about <span className="font-bold">rapid learning</span>, <span className="font-bold">problem-solving</span>, and leveraging <span className="font-bold">AI tools</span></p>
                </div>
                <div className="flex items-start gap-3 group/item hover:translate-x-1 transition-transform">
                  <span className="text-neon-cyan text-xl md:text-2xl mt-0.5">▹</span>
                  <p className="text-gray-300 text-base md:text-lg">Aspiring <span className="font-bold">remote software engineer</span> merging technical excellence with entrepreneurial vision</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-4 md:mb-5">
                <div className="border-2 border-neon-cyan/30 p-3 md:p-4 relative group/stat hover:border-neon-cyan hover:scale-105 transition-all duration-300">
                  ...
                  <p className="text-neon-cyan font-bold text-2xl md:text-3xl font-mono">1+ YR</p>
                </div>
                ...
                <div className="border-2 border-neon-cyan/30 p-3 md:p-4 relative group/stat hover:border-neon-cyan hover:scale-105 transition-all duration-300">
                  ...
                  <p className="text-neon-cyan font-bold text-2xl md:text-3xl font-mono">15+</p>
                </div>
                ...
                <div className="border-2 border-neon-cyan/30 p-3 md:p-4 relative group/stat hover:border-neon-cyan hover:scale-105 transition-all duration-300">
                  ...
                  <p className="text-neon-cyan font-bold text-2xl md:text-3xl font-mono">∞</p>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-x-6 gap-y-2">
                ...
                <div className="flex items-center gap-2 text-sm md:text-base">
                  ...
                  <span className="text-white font-mono font-bold">Available for work</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-2 bg-dark-800/50 backdrop-blur-sm border-2 border-neon-cyan/30 rounded-2xl p-4 md:p-6 relative group hover:border-neon-cyan/60 transition-all duration-500">
            <div className="absolute top-2 right-2 md:top-4 md:right-4 text-neon-cyan/20 text-4xl md:text-6xl font-mono">02</div>
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-5 md:space-y-6 relative">
                ...
                <div className="absolute left-2 top-3 bottom-3 w-0.5 bg-neon-cyan opacity-20" />
                ...
                <div className="relative pl-8 group/edu hover:translate-x-1 transition-transform">
                  ...
                  <div className="bg-dark-700/50 border border-neon-cyan/20 rounded-lg p-3 group-hover/edu:border-neon-cyan/60 transition-all">
                    ...
                    <div className="flex flex-wrap gap-1.5 mt-2">
                      ...
                      <span className="px-2 py-1 bg-neon-cyan/5 text-neon-cyan text-sm rounded border border-neon-cyan/20">NestJS</span>
                      <span className="px-2 py-1 bg-neon-cyan/5 text-neon-cyan text-sm rounded border border-neon-cyan/20">PostgreSQL</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative pl-8 group/edu hover:translate-x-1 transition-transform">
                  <div className="absolute left-0 top-1 w-4 h-4 rounded-full bg-neon-cyan border-2 border-dark-800 group-hover/edu:scale-125 group-hover/edu:shadow-lg group-hover/edu:shadow-neon-cyan/50 transition-all" />
                  <div className="bg-dark-700/50 border border-neon-cyan/20 rounded-lg p-3 group-hover/edu:border-neon-cyan/60 transition-all">
                    <p className="text-neon-cyan font-bold text-base md:text-lg font-mono leading-tight mb-2">UNPAB</p>
                    ...
                    <div className="flex flex-wrap gap-1.5 mt-2">
                      <span className="px-2 py-1 bg-neon-cyan/5 text-neon-cyan text-sm rounded border border-neon-cyan/20">HTML</span>
                      <span className="px-2 py-1 bg-neon-cyan/5 text-neon-cyan text-sm rounded border border-neon-cyan/20">CSS</span>
                      <span className="px-2 py-1 bg-neon-cyan/5 text-neon-cyan text-sm rounded border border-neon-cyan/20">JavaScript</span>
                      <span className="px-2 py-1 bg-neon-cyan/5 text-neon-cyan text-sm rounded border border-neon-cyan/20">PHP</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="mb-8">
          <div className="bg-dark-800/50 backdrop-blur-sm border-2 border-neon-cyan/30 rounded-2xl p-4 md:p-6 relative group hover:border-neon-cyan/60 transition-all duration-500">
            <div className="absolute top-2 right-2 md:top-4 md:right-4 text-neon-cyan/20 text-4xl md:text-6xl font-mono">03</div>
